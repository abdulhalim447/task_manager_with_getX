...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
  ...
  void getUserData() {
    UserData userData = Get.find<UserViewModelClass>().userData;
            ...
            childWidget: SingleChildScrollView(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Center(
                      child: GetBuilder<UserViewModelClass>(builder: (viewModel) {
                    ...
                    InkWell(
                      ...
                      onTap: () {
                        Get.find<UserViewModelClass>().getImageFromGallery();
                      },
                      child: Container(
                        height: 45,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: GetBuilder<UserViewModelClass>(
                                builder: (viewModel) {
  ...
  void updateProfile(UserViewModelClass viewModel) async {
