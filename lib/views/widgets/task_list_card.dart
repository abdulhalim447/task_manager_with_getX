...
class _TaskListCardState extends State<TaskListCard> {
                      ...
                      Builder(builder: (context) {
                        return ExpansionTile(
                          ...
                          onExpansionChanged: (value) {
                            Get.find<TaskViewModelClass>().setIsTileExpanded(
  ...
  Future<void> updateItem(BuildContext context, int index, String value) async {
    if (value != widget.currentScreen) {
      bool status = await Get.find<TaskViewModelClass>().updateTask(
          token: Get.find<UserViewModelClass>().token,
          taskId: widget.taskData[index].sId.toString(),
          taskStatus: value,
          currentScreenStatus: widget.currentScreen,
          index: index,
          dashboardViewModel: Get.find<DashboardViewModelClass>());
  ...
  Future<void> itemDeletion(BuildContext context, int index) async {
    bool status = await Get.find<TaskViewModelClass>().deleteTask(
      Get.find<UserViewModelClass>().token,
