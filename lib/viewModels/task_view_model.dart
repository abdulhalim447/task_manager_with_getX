...
class TaskViewModelClass extends GetxController {
  ...
  Future<bool> updateTask({
    ...
    required int index,
    required DashboardViewModelClass dashboardViewModel,
  }) async {
    setIsLoading(true);
  ...
  void removeBadgeCount(int index, DashboardViewModelClass dashboardViewModel) {
